    ...
    try:
        with engine.connect() as connection:
            result = connection.execute(text("""
                SELECT k.id_karyawan, k.nip, k.id_jenis, j.jenis, k.id_tipe, t.tipe, k.nama, k.nama_panggilan, k.gaji_pokok, k.username, k.password, k.kode_pemulihan, k.bank, k.no_rekening, k.an_rekening
                FROM karyawan k
